// More about keys here https://developer.mozilla.org/en-US/docs/Web/API/UI_Events/Keyboard_event_key_values
// This file is from https://github.com/Moh-Snoussi/keyboard-event-key-type
